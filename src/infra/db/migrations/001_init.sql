...
-- Tabelas de técnicas, profissões e receitas
...
CREATE INDEX IF NOT EXISTS idx_player_cultivation_player_id ON player_cultivation(player_id);
...
CREATE INDEX IF NOT EXISTS idx_game_logs_correlation_id ON game_logs(correlation_id);
